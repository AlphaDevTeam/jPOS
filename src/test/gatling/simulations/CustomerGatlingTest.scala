...
class CustomerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .post("/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "custCode":"SAMPLE_TEXT", "customerNIC":"SAMPLE_TEXT", "creditLimit":null, "isActive":null, "vatNumber":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
