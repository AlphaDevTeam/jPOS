...
class ItemGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Item entity")
        ...
        .repeat(2) {
            ...
            .post("/api/items")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "itemCode":"SAMPLE_TEXT", "itemTitle":"SAMPLE_TEXT", "itemBarcode":"SAMPLE_TEXT", "itemDescription":"SAMPLE_TEXT", "itemCost":null, "itemUnitPrice":null, "itemReorderLevel":null}""")).asJSON
            .check(status.is(201))
