package com.alphadevs.web.pos.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jPOS");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jPOS");
        ...
        config.getMapConfigs().put("com.alphadevs.web.pos.domain.*", initializeDomainMapConfig(jHipsterProperties));
